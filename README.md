...
[Agent installation guide](INSTALL.md) · [v0.2.3 release notes](docs/releases/v0.2.3.md) · [Recovery setup](docs/recovery-setup.md) · [Explore the skills](docs/skills.md) · [Architecture](docs/architecture/README.md) · [Status](#where-we-are)
...
| [Jira and activity](docs/console-jira.md) | Show tracker work and summarized progress in the Console without a second foreman moving the tickets. |
