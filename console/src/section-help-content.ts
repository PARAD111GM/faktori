...
const sections: Record<string, SectionHelp> = {
  ...
  artifacts: help('This artifact view only renders safe catalog projections. It does not browse or expose local artifact homes.', 'The owner-maintained workCatalog and its server-side safe projection.', 'Select a project, then use the stated content basis and freshness before relying on an artifact.'),
